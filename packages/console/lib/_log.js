...
export const LOGGER = () => { console.log("%c+", "font-size: 1px; padding: 180px 320px;background: url('https://c.tenor.com/ejU6O27fjvsAAAAd/among-us-drip.gif');background-repeat: no-repeat") 
